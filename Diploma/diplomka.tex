...
\paragraph*{}
Při biologické reprodukce je genetický materiál obou rodičů vyměňován tak, že výsledné geny dítěte jsou na přibližně stejném místě, jako tomu bylo u rodičovských genů. Což je však zcela odlišné od standardního křížení, kde mohou být podstromy přesunuty na zcela jinou pozici vzhledem k rodičovským stromům.

...
\InsertFigure{Figures/quintic-problem.png}{0.7\textwidth}{Průběh funkce $x^5-2x^3+x$}{fig:quintic_fce}

\begin{equation} \label{eq:sextic}
x^6-2x^4+x^2
\end{equation}

\InsertFigure{Figures/sextic-problem.png}{0.7\textwidth}{Průběh funkce $x^6-2x^4+x^2$}{fig:sextic_fce}

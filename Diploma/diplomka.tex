...
podměty a věnovaný čas při tvorbě této práce. Rovněž velmi děkuji svým rodičům a dalším rodinným příslušníkům za všestrannou podporu během studia. A nakonec bych chtěl poděkovat své přítelkyni, která při mne po celou dobu tvorby.
}
...
\InsertFigure{Figures/evol-progress.png}{0.7\textwidth}{Mutace schématicky na binárním řetězci}{fig:mutate}
...
\InsertFigure{Figures/evol-progress.png}{0.7\textwidth}{Schématický příklad křížení na binárním řetězci}{fig:crossover}
...
\InsertFigure{Figures/roulete_wheel.png}{0.5\textwidth}{Ruletové kolo}{fig:RouleteWheelSelect}

\subsubsection*{Rank selection}

\InsertFigure{Figures/rank-select.png}{0.5\textwidth}{Pořadový výběr}{fig:RankSelect}
...
\InsertFigure{Figures/one-point-cross.png}{0.7\textwidth}{Příklad jednobodového operátoru křížení}{fig:OnePointCrossover}
...
\InsertFigure{Figures/class-diagram.png}{1.0\textwidth}{Třídní diagram}{fig:classdiagram}
...
\InsertFigure{Figures/gui.png}{1.0\textwidth}{GUI aplikace EvolTool}{fig:maingui}
...
\InsertFigure{Figures/best_ant.png}{0.7\textwidth}{Nalezeno řešení}{fig:artificialant1}
...
\bibitem{langdonpoli} Langdon W. B., Poli R.,
